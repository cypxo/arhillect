...
# Form implementation generated from reading ui file 'train7.ui'
#
...
class train7(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 60, 631, 293))
        ...
        self.label_2.setPixmap(QtGui.QPixmap("train/train7.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Задание 7."))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><h3 style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; background-color:transparent;\"><span style=\" font-family:\'Liberation Serif,serif\'; font-size:14pt; font-weight:600; background-color:transparent;\">«Часики</span><span style=\" font-size:large; font-weight:600;\">»</span></h3><p>• Улыбнуться, открыть ротик.</p><p>• Тянуться язычком попеременно то </p><p>к левому уголку ротика, то к правому. </p><p>• в исходное положение на 5 сек. </p><p>• 15 повторений. </p></body></html>"))

...
class train2(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 60, 631, 282))
        ...
        self.label_2.setPixmap(QtGui.QPixmap("train/lopatochka.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Задание 2."))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><h3 style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; background-color:transparent;\"><span style=\" font-family:\'Liberation Serif,serif\'; font-size:14pt; font-weight:600; background-color:transparent;\">«Лопаточка</span><span style=\" font-size:large; font-weight:600;\">»</span></h3><p>• Открыть рот, положить и расслабить </p><p>язык на нижнюю губу. </p><p>• Подержать в таком положении 10 секунд. </p><p>• Примечание. Не прикусывать язык ни </p><p>губами, ни зубами. Следить, чтобы </p><p>язык не дрожал.</p><p>• в исходное положение на 3 сек. </p><p>• 8 повторений х 1 подход. </p></body></html>"))

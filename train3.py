...
class train3(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setPixmap(QtGui.QPixmap("train/train3.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Задание 3."))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><h3 style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; background-color:transparent;\"><span style=\" font-family:\'Liberation Serif,serif\'; font-size:14pt; font-weight:600; background-color:transparent;\">«Чистим зубки</span><span style=\" font-size:large; font-weight:600;\">»</span></h3><p>• Улыбнуться, открыть рот. Кончиком языка </p><p>сильно «почистить» за нижними зубами </p><p>(влево - вправо) под счёт до десяти </p><p>• Затем поднять язычок вверх и почистить </p><p>за верхними зубками ( рот широко открыть). </p><p>• в исходное положение на 5 сек. </p><p>• 4 повторений х 1 подход. </p></body></html>"))
